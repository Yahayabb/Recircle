...
class recycle_electronic : AppCompatActivity() {

    var ghgp: Double = 50.0;
    var fuelp: Double = 2.8;
    var powerp: Double = 4.0;
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_recycle_electronic)
